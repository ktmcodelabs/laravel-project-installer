...
class InstallApplication extends Command
{
    ...
    */
    private function createDatabase(){
        ...
        if( $this->updateEnvironmentFile($settings) && !$this->testDbConnection()){
    ...
    */
    private function testDbConnection(){
        ...
        $this->info('Database connection working. Connected to :'.DB::getDatabaseName());
        return true;
    }
